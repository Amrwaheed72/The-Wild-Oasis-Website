      ...
      <form
        ...
        <div className='flex justify-end items-center gap-6'>
          {!(startDate && endDate) ?
            ...
            <Button runningState="Reserving..." originalState="Reserve now" style="cursor-pointer bg-accent-500 px-8 py-4 text-primary-800 font-semibold hover:bg-accent-600 transition-all disabled:cursor-not-allowed disabled:bg-gray-500 disabled:text-gray-300" />}
        </div>
      </form>
    </div>
  );
